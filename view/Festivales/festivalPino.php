...
<div class="contenido-fiestas">
  ...
  <p>
    ...
    principal objetivo del festival es promover la protección y conservar el patrimonio ecológico y cultural del municipio por
    medio de actividade recreativas esta feria se realiza desde 1976 con el objetivo de incrementar el turismo interno 
    y de igual forma hacer conciencia de la vital importancia de cuidar los pinos de país.
    <br><br>
    El Festival Nacional del Pino,  es un evento que nació por la necesidad de mostrar a Honduras y el mundo la abundante foresta
    que tiene Siguatepeque, lo que deriva un clima agradable y cuantiosa agua.
    <br><br>
    Cuando inicio no tuvo un objetivo definido sobre lo que significaba el festival del Pino, ha medida han pasado los años se nombraron 
    varias comisiones que trabajan presencialmente para que cada año se realice este gran festejo. Para que el público de la ciudad y 
    turistas puedan disfrutar de todas las actividades realizadas durante la fecha. Siguatepeque es conocida como la Ciudad de los pinares
