<!-- Header -->
<?php 
  $tittle ="Justicia Municipal - Municipalidad de Siguatepeque";
  require_once '../layouts/header.php'; 
?>

<!-- Contenido de la navegación -->
<div class="oficina">
    <h1>JUSTICIA MUNICIPAL</h1>
    <aside class="aside">
        <img src="/img/deptos/justicia-municipal.png" alt="">
        <p>El departamento de <b>Justicia Municipal</b> ofrece los servicios a la ciudadania</p>
