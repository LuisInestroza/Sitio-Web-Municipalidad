    ...
    <div class="images">
        ...
        <div class="hero-slider">
            ...
            <div class="contenido-slider">
                ...
                <div class="datos-ciudad">
                    ...
                    <div class="dato">
                        <p><i class="fa fa-cloud-sun"></i><br>SU TEMPERATURA OSCILA <br> ENTRE 20º C Y 25º C</p>
                    </div>
                    <div class="dato">
                        <p>1926 <br>AÑO DE FUNDACIÓN</p>
                    </div>
                    <div class="dato">
                        <P>100,000<br>POBLACIÓN APROXIMADA</P>
                    </div>
                </div>
            </div>
        </div>
        <div class="hero-slider">
            ...
            <div class="contenido-slider">
                ...
                <a href="/Festivales/fesivalFlores.php">Información</a>
            </div>
        </div>
        <div class="hero-slider">
            ...
            <div class="contenido-slider">
                ...
                <a href="/Relax/relax.php">Ver Lugares</a>
            </div>
        </div>
            ...
            <div class="tabs tabs-style-tzoid">
                ...
                <div class="content-wrap ">
                    ...
                    <div class="btn-noticias">
                        <a href="/Noticias/noticias.php">LEER MAS NOTICIAS</a>
                    </div>
