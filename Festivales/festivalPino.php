...
<div class="contenido-fiestas">
    ...
    <div class="carousel-img" data-flickity> 
        <img class="carousel-cell-img" src="/img/festivales/festivalPino5.jpg" alt="">
        <img class="carousel-cell-img" src="/img/festivales/festivalPino1.jpg" alt="">
        <img class="carousel-cell-img" src="/img/festivales/festivalPino2.jpg" alt="">
        <img class="carousel-cell-img" src="/img/festivales/festivalPino3.jpg" alt="">
        <img class="carousel-cell-img" src="/img/festivales/festivalPino4.jpg" alt="">
    </div>
