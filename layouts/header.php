...
<body>
        ...
        <nav class=menu>
            <ul>
                ...
                <li class="subMenu">
                    ...
                    <ul class="children">
                        <li>
                            <a href="/Gobierno/alcaldeMunicipal.php">
                                <i class="fa fa-user-tie"></i>
                                <b>Alcalde Municipal</b>
                            </a>
                        </li>
                        <li>
                            <a href="/Gobierno/departamentosMunicipalidad.php">
                ...
                <li class="subMenu">
                    ...
                    <ul class="children">
                        <li>
                            ...
                            <a href="/ConoceSiguatepeque/contactos.php">
                        ...
                        <li>
                            ...
                            <a href="/Relax/relax.php">
                                <i class="fa fa-map-marked"></i>
                                <b>Lugares Populares</b>
                            </a>
                        </li>
                        <li>
                            <a href="/ConoceSiguatepeque/educacionSuperior.php">
                                <i class="fa fa-graduation-cap"></i>
                                <b>Educación Superior</b>
                            </a>
                        </li>
                        <li>
                            <a href="/ConoceSiguatepeque/historiaSiguatepeque.php">
                ...
                <li>
                    <a href="http://muni-system/login.php">
    ...
    <div id="hero" class="hero">
        <form action="/search/search.php" class="busqueda">
            <fieldset>
